...
| `MOODLE_DOCKER_BROWSER`                   | no        | firefox, chrome,  firefox:&lt;tag&gt;, chrome:&lt;tag&gt; | firefox       | The browser to run Behat against. Supports a colon notation to specify a docker image version to use              |
