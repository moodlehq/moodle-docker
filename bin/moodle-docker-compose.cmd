...
IF "%MOODLE_DOCKER_DB_MANAGER_PORT%"=="" (
    SET MOODLE_DOCKER_DB_MANAGER_PORT=8900
)
...
IF NOT "%MOODLE_DOCKER_DB_MANAGER%"=="" (
    SET DOCKERCOMPOSE=%DOCKERCOMPOSE% -f "%BASEDIR%\%MOODLE_DOCKER_DB_MANAGER%.yml"
)
