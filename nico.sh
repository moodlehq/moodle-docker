...
adminer_plugins () {
    ...
    docker cp assets/adminer/plugins/readable-dates.php docker2-Adminer:/var/www/html/plugins/readable-dates.php
    docker cp assets/adminer/plugins/table-header-scroll.php docker2-Adminer:/var/www/html/plugins/table-header-scroll.php
    docker cp assets/adminer/plugins/002-readable-dates.php docker2-Adminer:/var/www/html/plugins-enabled/002-readable-dates.php
    docker cp assets/adminer/plugins/003-table-header-scroll.php docker2-Adminer:/var/www/html/plugins-enabled/003-table-header-scroll.php
}
...
if [ "$SWITCH" = "--help" ]; then
    echo "Usage: sh run.sh [folder] [option] [option2]"
